...
const MicrosoftSvg = () => {
  return (
    ...
    >
      <rect width="90" height="90" fill="url(#pattern0_1_204)" />
      <defs>
        <pattern
          id="pattern0_1_204"
          ...
          height="1"
        >
          <use xlink:href="#image0_1_204" transform="scale(0.0111111)" />
        </pattern>
        <image
          id="image0_1_204"
          width="90"
